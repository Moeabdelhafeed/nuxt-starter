export const useAuthConfig = () => {
  ...
  const { cfg, isOtpMode } = flags
  // Taken once here, in setup, rather than inside `labelFor` & co: a composable that
  // fetches (useLang → useApiFetch) must not be created during render.
